...
// DefaultAccountNASessionNoRating is session data with no rating battles (regular only) for render/layout tests.
const DefaultAccountNASessionNoRating = "10003333008"
