...
const (
	// Label holds the string label denoting the userconnection type in the database.
	Label = "user_connection"
	...
	EdgeUser = "user"
	// Table holds the table name of the userconnection in the database.
	Table = "user_connections"
	// UserTable is the table that holds the user relation/edge.
	UserTable = "user_connections"
...
// Columns holds all SQL columns for userconnection fields.
var Columns = []string{
	FieldID,
	FieldCreatedAt,
	FieldUpdatedAt,
...
func TypeValidator(_type models.ConnectionType) error {
	switch _type {
	case "wargaming":
		return nil
	default:
		return fmt.Errorf("userconnection: invalid enum value for type field: %q", _type)
	}
}

// OrderOption defines the ordering options for the UserConnection queries.
