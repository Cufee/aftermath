-- Create "clan" table
CREATE TABLE "clan" ("id" text NOT NULL, "created_at" text NOT NULL, "updated_at" text NOT NULL, "tag" text NOT NULL, "name" text NOT NULL, "emblem_id" text NULL DEFAULT '', "members" bytea NOT NULL DEFAULT '\x', PRIMARY KEY ("id"));
...
CREATE TABLE "game_mode" ("id" text NOT NULL, "created_at" text NOT NULL, "updated_at" text NOT NULL, "localized_names" bytea NOT NULL DEFAULT '\x', PRIMARY KEY ("id"));
...
CREATE TABLE "vehicle_average" ("id" text NOT NULL, "created_at" text NOT NULL, "updated_at" text NOT NULL, "data" bytea NOT NULL DEFAULT '\x', PRIMARY KEY ("id"));
...
CREATE TABLE "app_configuration" ("id" text NOT NULL, "created_at" text NOT NULL, "updated_at" text NOT NULL, "key" text NOT NULL, "value" bytea NOT NULL DEFAULT '\x', "metadata" bytea NOT NULL DEFAULT '\x', PRIMARY KEY ("id"));
...
CREATE TABLE "auth_nonce" ("id" text NOT NULL, "created_at" text NOT NULL, "updated_at" text NOT NULL, "active" boolean NOT NULL, "expires_at" text NOT NULL, "identifier" text NOT NULL, "public_id" text NOT NULL, "metadata" bytea NOT NULL DEFAULT '\x', PRIMARY KEY ("id"));
...
CREATE TABLE "account" ("id" text NOT NULL, "created_at" text NOT NULL, "updated_at" text NOT NULL, "last_battle_time" text NOT NULL, "account_created_at" text NOT NULL, "realm" text NOT NULL, "nickname" text NOT NULL, "private" boolean NOT NULL DEFAULT false, "clan_id" text NULL, PRIMARY KEY ("id"));
...
CREATE TABLE "manual_migration" ("id" text NOT NULL, "created_at" text NOT NULL, "updated_at" text NOT NULL, "key" text NOT NULL, "finished" boolean NOT NULL, "metadata" bytea NOT NULL DEFAULT '\x', PRIMARY KEY ("id"));
...
CREATE TABLE "vehicle" ("id" text NOT NULL, "created_at" text NOT NULL, "updated_at" text NOT NULL, "tier" integer NOT NULL, "localized_names" bytea NOT NULL DEFAULT '\x', PRIMARY KEY ("id"));
-- Create index "vehicle_id_idx" to table: "vehicle"
CREATE INDEX "vehicle_id_idx" ON "vehicle" ("id");
-- Create "game_map" table
CREATE TABLE "game_map" ("id" text NOT NULL, "created_at" text NOT NULL, "updated_at" text NOT NULL, "game_modes" bytea NOT NULL DEFAULT '\x', "supremacy_points" integer NOT NULL, "localized_names" bytea NOT NULL DEFAULT '\x', PRIMARY KEY ("id"));
-- Create index "game_map_id_idx" to table: "game_map"
CREATE INDEX "game_map_id_idx" ON "game_map" ("id");
-- Create "cron_task" table
CREATE TABLE "cron_task" ("id" text NOT NULL, "created_at" text NOT NULL, "updated_at" text NOT NULL, "type" text NOT NULL, "reference_id" text NOT NULL, "targets" bytea NOT NULL DEFAULT '\x', "status" text NOT NULL, "scheduled_after" text NOT NULL, "last_run" text NOT NULL, "tries_left" integer NOT NULL DEFAULT 0, "logs" bytea NOT NULL DEFAULT '\x', "data" bytea NOT NULL DEFAULT '\x', PRIMARY KEY ("id"));
...
CREATE TABLE "account_achievements_snapshot" ("id" text NOT NULL, "created_at" text NOT NULL, "type" text NOT NULL, "battles" integer NOT NULL, "last_battle_time" text NOT NULL, "reference_id" text NOT NULL, "frame" bytea NOT NULL DEFAULT '\x', "account_id" text NOT NULL, PRIMARY KEY ("id"), CONSTRAINT "account_id_account_achievements_snapshot_account_id_fk" FOREIGN KEY ("account_id") REFERENCES "account" ("id") ON UPDATE NO ACTION ON DELETE CASCADE);
...
CREATE TABLE "account_snapshot" ("id" text NOT NULL, "created_at" text NOT NULL, "type" text NOT NULL, "last_battle_time" text NOT NULL, "reference_id" text NOT NULL, "rating_battles" integer NOT NULL, "rating_frame" bytea NOT NULL DEFAULT '\x', "regular_battles" integer NOT NULL, "regular_frame" bytea NOT NULL DEFAULT '\x', "account_id" text NOT NULL, PRIMARY KEY ("id"), CONSTRAINT "account_account_id_snapshot_account_id_fk" FOREIGN KEY ("account_id") REFERENCES "account" ("id") ON UPDATE NO ACTION ON DELETE CASCADE);
...
-- Create "user" table
CREATE TABLE "user" ("id" text NOT NULL, "created_at" text NOT NULL, "updated_at" text NOT NULL, "username" text NOT NULL DEFAULT '', "permissions" text NOT NULL DEFAULT '', "feature_flags" bytea NOT NULL DEFAULT '\x', PRIMARY KEY ("id"));
...
CREATE TABLE "discord_interaction" ("id" text NOT NULL, "created_at" text NOT NULL, "updated_at" text NOT NULL, "result" text NOT NULL, "event_id" text NOT NULL, "guild_id" text NOT NULL, "snowflake" text NOT NULL DEFAULT '', "channel_id" text NOT NULL, "message_id" text NOT NULL, "type" text NOT NULL, "locale" text NOT NULL, "metadata" bytea NOT NULL DEFAULT '\x', "user_id" text NOT NULL, PRIMARY KEY ("id"), CONSTRAINT "discord_interaction_user_id_fk" FOREIGN KEY ("user_id") REFERENCES "user" ("id") ON UPDATE NO ACTION ON DELETE CASCADE);
...
CREATE TABLE "session" ("id" text NOT NULL, "created_at" text NOT NULL, "updated_at" text NOT NULL, "expires_at" text NOT NULL, "public_id" text NOT NULL, "metadata" bytea NOT NULL DEFAULT '\x', "user_id" text NOT NULL, PRIMARY KEY ("id"), CONSTRAINT "session_user_id_fk" FOREIGN KEY ("user_id") REFERENCES "user" ("id") ON UPDATE NO ACTION ON DELETE CASCADE);
...
CREATE TABLE "user_connection" ("id" text NOT NULL, "created_at" text NOT NULL, "updated_at" text NOT NULL, "type" text NOT NULL, "verified" boolean NOT NULL DEFAULT false, "selected" boolean NOT NULL DEFAULT false, "reference_id" text NOT NULL, "permissions" text NULL DEFAULT '', "metadata" bytea NOT NULL DEFAULT '\x', "user_id" text NOT NULL, PRIMARY KEY ("id"), CONSTRAINT "user_connection_user_id_fk" FOREIGN KEY ("user_id") REFERENCES "user" ("id") ON UPDATE NO ACTION ON DELETE CASCADE);
...
CREATE TABLE "user_content" ("id" text NOT NULL, "created_at" text NOT NULL, "updated_at" text NOT NULL, "type" text NOT NULL, "reference_id" text NOT NULL, "value" text NOT NULL, "metadata" bytea NOT NULL DEFAULT '\x', "user_id" text NOT NULL, PRIMARY KEY ("id"), CONSTRAINT "user_content_user_id_fk" FOREIGN KEY ("user_id") REFERENCES "user" ("id") ON UPDATE NO ACTION ON DELETE CASCADE);
...
CREATE TABLE "user_subscription" ("id" text NOT NULL, "created_at" text NOT NULL, "updated_at" text NOT NULL, "type" text NOT NULL, "expires_at" text NOT NULL, "permissions" text NOT NULL, "reference_id" text NOT NULL, "user_id" text NOT NULL, "metadata" bytea NOT NULL DEFAULT '\x', PRIMARY KEY ("id"), CONSTRAINT "user_subscription_user_id_fk" FOREIGN KEY ("user_id") REFERENCES "user" ("id") ON UPDATE NO ACTION ON DELETE CASCADE);
...
CREATE TABLE "vehicle_achievements_snapshot" ("id" text NOT NULL, "created_at" text NOT NULL, "type" text NOT NULL, "vehicle_id" text NOT NULL, "reference_id" text NOT NULL, "battles" integer NOT NULL, "last_battle_time" text NOT NULL, "frame" bytea NOT NULL DEFAULT '\x', "account_id" text NOT NULL, PRIMARY KEY ("id"), CONSTRAINT "vehicle_achievements_snapshot_account_id_account_id_fk" FOREIGN KEY ("account_id") REFERENCES "account" ("id") ON UPDATE NO ACTION ON DELETE CASCADE);
...
CREATE TABLE "vehicle_snapshot" ("id" text NOT NULL, "created_at" text NOT NULL, "type" text NOT NULL, "vehicle_id" text NOT NULL, "reference_id" text NOT NULL, "battles" integer NOT NULL, "last_battle_time" text NOT NULL, "frame" bytea NOT NULL DEFAULT '\x', "account_id" text NOT NULL, PRIMARY KEY ("id"), CONSTRAINT "vehicle_snapshot_account_id_account_id_fk" FOREIGN KEY ("account_id") REFERENCES "account" ("id") ON UPDATE NO ACTION ON DELETE CASCADE);
...
CREATE TABLE "widget_settings" ("id" text NOT NULL, "created_at" text NOT NULL, "updated_at" text NOT NULL, "reference_id" text NOT NULL, "title" text NULL, "session_from" text NULL, "metadata" bytea NOT NULL DEFAULT '\x', "styles" bytea NOT NULL DEFAULT '\x', "user_id" text NOT NULL, "session_reference_id" text NULL, PRIMARY KEY ("id"), CONSTRAINT "widget_setting_user_id_user_id_fk" FOREIGN KEY ("user_id") REFERENCES "user" ("id") ON UPDATE NO ACTION ON DELETE CASCADE);
