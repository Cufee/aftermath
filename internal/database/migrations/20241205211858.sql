...
-- Create "new_application_command" table
CREATE TABLE `new_application_command` (`id` text NOT NULL, `created_at` text NOT NULL, `updated_at` text NOT NULL, `name` text NOT NULL, `version` text NOT NULL, `options_hash` text NOT NULL, PRIMARY KEY (`id`));
-- Copy rows from old table "application_command" to new temporary table "new_application_command"
INSERT INTO `new_application_command` (`id`, `created_at`, `updated_at`, `name`, `version`, `options_hash`) SELECT `id`, `created_at`, `updated_at`, `name`, `version`, `options_hash` FROM `application_command`;
-- Drop "application_command" table after copying rows
DROP TABLE `application_command`;
-- Rename temporary table "new_application_command" to "application_command"
ALTER TABLE `new_application_command` RENAME TO `application_command`;
...
CREATE TABLE `new_user_subscription` (`id` text NOT NULL, `created_at` text NOT NULL, `updated_at` text NOT NULL, `type` text NOT NULL, `expires_at` text NOT NULL, `permissions` text NOT NULL, `reference_id` text NOT NULL, `user_id` text NOT NULL, PRIMARY KEY (`id`), CONSTRAINT `user_subscription_user_id_fk` FOREIGN KEY (`user_id`) REFERENCES `user` (`id`) ON UPDATE NO ACTION ON DELETE CASCADE);
...
CREATE TABLE `new_app_configuration` (`id` text NOT NULL, `created_at` text NOT NULL, `updated_at` text NOT NULL, `key` text NOT NULL, `value` blob NOT NULL DEFAULT '', `metadata` blob NOT NULL DEFAULT '', PRIMARY KEY (`id`));
-- Copy rows from old table "app_configuration" to new temporary table "new_app_configuration"
INSERT INTO `new_app_configuration` (`id`, `created_at`, `updated_at`, `key`, `value`, `metadata`) SELECT `id`, `created_at`, `updated_at`, `key`, `value`, `metadata` FROM `app_configuration`;
...
CREATE TABLE `new_auth_nonce` (`id` text NOT NULL, `created_at` text NOT NULL, `updated_at` text NOT NULL, `active` bool NOT NULL, `expires_at` text NOT NULL, `identifier` text NOT NULL, `public_id` text NOT NULL, `metadata` blob NOT NULL DEFAULT '', PRIMARY KEY (`id`));
-- Copy rows from old table "auth_nonce" to new temporary table "new_auth_nonce"
INSERT INTO `new_auth_nonce` (`id`, `created_at`, `updated_at`, `active`, `expires_at`, `identifier`, `public_id`, `metadata`) SELECT `id`, `created_at`, `updated_at`, `active`, `expires_at`, `identifier`, `public_id`, `metadata` FROM `auth_nonce`;
...
CREATE TABLE `new_clan` (`id` text NOT NULL, `created_at` text NOT NULL, `updated_at` text NOT NULL, `tag` text NOT NULL, `name` text NOT NULL, `emblem_id` text NULL DEFAULT '', `members` blob NOT NULL DEFAULT '', PRIMARY KEY (`id`));
-- Copy rows from old table "clan" to new temporary table "new_clan"
INSERT INTO `new_clan` (`id`, `created_at`, `updated_at`, `tag`, `name`, `emblem_id`, `members`) SELECT `id`, `created_at`, `updated_at`, `tag`, `name`, `emblem_id`, `members` FROM `clan`;
...
CREATE TABLE `new_cron_task` (`id` text NOT NULL, `created_at` text NOT NULL, `updated_at` text NOT NULL, `type` text NOT NULL, `reference_id` text NOT NULL, `targets` blob NOT NULL DEFAULT '', `status` text NOT NULL, `scheduled_after` text NOT NULL, `last_run` text NOT NULL, `tries_left` integer NOT NULL DEFAULT 0, `logs` blob NOT NULL DEFAULT '', `data` blob NOT NULL DEFAULT '', PRIMARY KEY (`id`));
-- Copy rows from old table "cron_task" to new temporary table "new_cron_task"
INSERT INTO `new_cron_task` (`id`, `created_at`, `updated_at`, `type`, `reference_id`, `targets`, `status`, `scheduled_after`, `last_run`, `tries_left`, `logs`, `data`) SELECT `id`, `created_at`, `updated_at`, `type`, `reference_id`, `targets`, `status`, `scheduled_after`, `last_run`, `tries_left`, `logs`, `data` FROM `cron_task`;
...
CREATE TABLE `new_session` (`id` text NOT NULL, `created_at` text NOT NULL, `updated_at` text NOT NULL, `expires_at` text NOT NULL, `public_id` text NOT NULL, `metadata` blob NOT NULL DEFAULT '', `user_id` text NOT NULL, PRIMARY KEY (`id`), CONSTRAINT `session_user_id_fk` FOREIGN KEY (`user_id`) REFERENCES `user` (`id`) ON UPDATE NO ACTION ON DELETE CASCADE);
-- Copy rows from old table "session" to new temporary table "new_session"
INSERT INTO `new_session` (`id`, `created_at`, `updated_at`, `expires_at`, `public_id`, `metadata`, `user_id`) SELECT `id`, `created_at`, `updated_at`, `expires_at`, `public_id`, `metadata`, `user_id` FROM `session`;
...
CREATE TABLE `new_user` (`id` text NOT NULL, `created_at` text NOT NULL, `updated_at` text NOT NULL, `username` text NOT NULL DEFAULT '', `permissions` text NOT NULL DEFAULT '', `feature_flags` blob NOT NULL DEFAULT '', PRIMARY KEY (`id`));
-- Copy rows from old table "user" to new temporary table "new_user"
INSERT INTO `new_user` (`id`, `created_at`, `updated_at`, `username`, `permissions`, `feature_flags`) SELECT `id`, `created_at`, `updated_at`, `username`, `permissions`, `feature_flags` FROM `user`;
...
CREATE TABLE `new_vehicle` (`id` text NOT NULL, `created_at` text NOT NULL, `updated_at` text NOT NULL, `tier` integer NOT NULL, `localized_names` blob NOT NULL DEFAULT '', PRIMARY KEY (`id`));
-- Copy rows from old table "vehicle" to new temporary table "new_vehicle"
INSERT INTO `new_vehicle` (`id`, `created_at`, `updated_at`, `tier`, `localized_names`) SELECT `id`, `created_at`, `updated_at`, `tier`, `localized_names` FROM `vehicle`;
...
CREATE TABLE `new_vehicle_average` (`id` text NOT NULL, `created_at` text NOT NULL, `updated_at` text NOT NULL, `data` blob NOT NULL DEFAULT '', PRIMARY KEY (`id`));
-- Copy rows from old table "vehicle_average" to new temporary table "new_vehicle_average"
INSERT INTO `new_vehicle_average` (`id`, `created_at`, `updated_at`, `data`) SELECT `id`, `created_at`, `updated_at`, `data` FROM `vehicle_average`;
...
CREATE TABLE `new_vehicle_snapshot` (`id` text NOT NULL, `created_at` text NOT NULL, `updated_at` text NOT NULL, `type` text NOT NULL, `vehicle_id` text NOT NULL, `reference_id` text NOT NULL, `battles` integer NOT NULL, `last_battle_time` text NOT NULL, `frame` blob NOT NULL DEFAULT '', `account_id` text NOT NULL, PRIMARY KEY (`id`), CONSTRAINT `vehicle_snapshot_account_id_account_id_fk` FOREIGN KEY (`account_id`) REFERENCES `account` (`id`) ON UPDATE NO ACTION ON DELETE CASCADE);
-- Copy rows from old table "vehicle_snapshot" to new temporary table "new_vehicle_snapshot"
INSERT INTO `new_vehicle_snapshot` (`id`, `created_at`, `updated_at`, `type`, `vehicle_id`, `reference_id`, `battles`, `last_battle_time`, `frame`, `account_id`) SELECT `id`, `created_at`, `updated_at`, `type`, `vehicle_id`, `reference_id`, `battles`, `last_battle_time`, `frame`, `account_id` FROM `vehicle_snapshot`;
...
CREATE TABLE `new_game_map` (`id` text NOT NULL, `created_at` text NOT NULL, `updated_at` text NOT NULL, `game_modes` blob NOT NULL DEFAULT '', `supremacy_points` integer NOT NULL, `localized_names` blob NOT NULL DEFAULT '', PRIMARY KEY (`id`));
-- Copy rows from old table "game_map" to new temporary table "new_game_map"
INSERT INTO `new_game_map` (`id`, `created_at`, `updated_at`, `game_modes`, `supremacy_points`, `localized_names`) SELECT `id`, `created_at`, `updated_at`, `game_modes`, `supremacy_points`, `localized_names` FROM `game_map`;
...
INSERT INTO `new_widget_settings` (`id`, `created_at`, `updated_at`, `reference_id`, `title`, `session_from`, `metadata`, `styles`, `user_id`, `session_reference_id`) SELECT `id`, `created_at`, `updated_at`, `reference_id`, `title`, `session_from`, `metadata`, `styles`, `user_id`, `session_reference_id` FROM `widget_settings`;
...
CREATE TABLE `new_game_mode` (`id` text NOT NULL, `created_at` text NOT NULL, `updated_at` text NOT NULL, `localized_names` blob NOT NULL DEFAULT '', PRIMARY KEY (`id`));
-- Copy rows from old table "game_mode" to new temporary table "new_game_mode"
INSERT INTO `new_game_mode` (`id`, `created_at`, `updated_at`, `localized_names`) SELECT `id`, `created_at`, `updated_at`, `localized_names` FROM `game_mode`;
...
CREATE TABLE `new_user_restriction` (`id` text NOT NULL, `created_at` text NOT NULL, `updated_at` text NOT NULL, `expires_at` text NOT NULL, `type` text NOT NULL, `restriction` text NOT NULL, `public_reason` text NOT NULL, `moderator_comment` text NOT NULL, `events` blob NOT NULL DEFAULT '', `user_id` text NOT NULL, PRIMARY KEY (`id`), CONSTRAINT `user_restriction_user_id_fk` FOREIGN KEY (`user_id`) REFERENCES `user` (`id`) ON UPDATE NO ACTION ON DELETE NO ACTION);
-- Copy rows from old table "user_restriction" to new temporary table "new_user_restriction"
INSERT INTO `new_user_restriction` (`id`, `created_at`, `updated_at`, `expires_at`, `type`, `restriction`, `public_reason`, `moderator_comment`, `events`, `user_id`) SELECT `id`, `created_at`, `updated_at`, `expires_at`, `type`, `restriction`, `public_reason`, `moderator_comment`, `events`, `user_id` FROM `user_restriction`;
...
CREATE TABLE `new_user_content` (`id` text NOT NULL, `created_at` text NOT NULL, `updated_at` text NOT NULL, `type` text NOT NULL, `reference_id` text NOT NULL, `value` text NOT NULL, `metadata` blob NOT NULL DEFAULT '', `user_id` text NOT NULL, PRIMARY KEY (`id`), CONSTRAINT `user_content_user_id_fk` FOREIGN KEY (`user_id`) REFERENCES `user` (`id`) ON UPDATE NO ACTION ON DELETE CASCADE);
-- Copy rows from old table "user_content" to new temporary table "new_user_content"
INSERT INTO `new_user_content` (`id`, `created_at`, `updated_at`, `type`, `reference_id`, `value`, `metadata`, `user_id`) SELECT `id`, `created_at`, `updated_at`, `type`, `reference_id`, `value`, `metadata`, `user_id` FROM `user_content`;
...
CREATE TABLE `new_discord_interaction` (`id` text NOT NULL, `created_at` text NOT NULL, `updated_at` text NOT NULL, `result` text NOT NULL, `event_id` text NOT NULL, `guild_id` text NOT NULL, `snowflake` text NOT NULL DEFAULT '', `channel_id` text NOT NULL, `message_id` text NOT NULL, `type` text NOT NULL, `locale` text NOT NULL, `metadata` blob NOT NULL DEFAULT '', `user_id` text NOT NULL, PRIMARY KEY (`id`), CONSTRAINT `discord_interaction_user_id_fk` FOREIGN KEY (`user_id`) REFERENCES `user` (`id`) ON UPDATE NO ACTION ON DELETE CASCADE);
-- Copy rows from old table "discord_interaction" to new temporary table "new_discord_interaction"
INSERT INTO `new_discord_interaction` (`id`, `created_at`, `updated_at`, `result`, `event_id`, `guild_id`, `snowflake`, `channel_id`, `message_id`, `type`, `locale`, `metadata`, `user_id`) SELECT `id`, `created_at`, `updated_at`, `result`, `event_id`, `guild_id`, `snowflake`, `channel_id`, `message_id`, `type`, `locale`, `metadata`, `user_id` FROM `discord_interaction`;
...
CREATE TABLE `new_user_connection` (`id` text NOT NULL, `created_at` text NOT NULL, `updated_at` text NOT NULL, `type` text NOT NULL, `verified` bool NOT NULL DEFAULT false, `selected` bool NOT NULL DEFAULT false, `reference_id` text NOT NULL, `permissions` text NULL DEFAULT '', `metadata` blob NOT NULL DEFAULT '', `user_id` text NOT NULL, PRIMARY KEY (`id`), CONSTRAINT `user_connection_user_id_fk` FOREIGN KEY (`user_id`) REFERENCES `user` (`id`) ON UPDATE NO ACTION ON DELETE CASCADE);
-- Copy rows from old table "user_connection" to new temporary table "new_user_connection"
INSERT INTO `new_user_connection` (`id`, `created_at`, `updated_at`, `type`, `verified`, `selected`, `reference_id`, `permissions`, `metadata`, `user_id`) SELECT `id`, `created_at`, `updated_at`, `type`, `verified`, `selected`, `reference_id`, `permissions`, `metadata`, `user_id` FROM `user_connection`;
...
CREATE TABLE `new_account` (`id` text NOT NULL, `created_at` text NOT NULL, `updated_at` text NOT NULL, `last_battle_time` text NOT NULL, `account_created_at` text NOT NULL, `realm` text NOT NULL, `nickname` text NOT NULL, `private` bool NOT NULL DEFAULT false, `clan_id` text NULL, PRIMARY KEY (`id`));
...
CREATE TABLE `new_account_snapshot` (`id` text NOT NULL, `created_at` text NOT NULL, `updated_at` text NOT NULL, `type` text NOT NULL, `last_battle_time` text NOT NULL, `reference_id` text NOT NULL, `rating_battles` integer NOT NULL, `rating_frame` blob NOT NULL DEFAULT '', `regular_battles` integer NOT NULL, `regular_frame` blob NOT NULL DEFAULT '', `account_id` text NOT NULL, PRIMARY KEY (`id`), CONSTRAINT `account_account_id_snapshot_account_id_fk` FOREIGN KEY (`account_id`) REFERENCES `account` (`id`) ON UPDATE NO ACTION ON DELETE CASCADE);
