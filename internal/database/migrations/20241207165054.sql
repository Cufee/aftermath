...
INSERT INTO `new_account_snapshot` (`id`, `created_at`, `type`, `last_battle_time`, `reference_id`, `rating_battles`, `rating_frame`, `regular_battles`, `regular_frame`, `account_id`) SELECT `id`, `created_at`, `type`, `last_battle_time`, `reference_id`, `rating_battles`, IFNULL(`rating_frame`, '') AS `rating_frame`, `regular_battles`, IFNULL(`regular_frame`, '') AS `regular_frame`, `account_id` FROM `account_snapshot`;
...
INSERT INTO `new_user_connection` (`id`, `created_at`, `updated_at`, `type`, `reference_id`, `permissions`, `metadata`, `user_id`) SELECT `id`, `created_at`, `updated_at`, `type`, `reference_id`, `permissions`, IFNULL(`metadata`, '') AS `metadata`, `user_id` FROM `user_connection`;
...
INSERT INTO `new_vehicle_snapshot` (`id`, `created_at`, `type`, `vehicle_id`, `reference_id`, `battles`, `last_battle_time`, `frame`, `account_id`) SELECT `id`, `created_at`, `type`, `vehicle_id`, `reference_id`, `battles`, `last_battle_time`, IFNULL(`frame`, '') AS `frame`, `account_id` FROM `vehicle_snapshot`;
