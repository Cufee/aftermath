...
func newSessionTableImpl(schemaName, tableName, alias string) sessionTable {
	var (
		...
		allColumns      = sqlite.ColumnList{IDColumn, CreatedAtColumn, UpdatedAtColumn, ExpiresAtColumn, PublicIDColumn, MetadataColumn, UserIDColumn}
		mutableColumns  = sqlite.ColumnList{CreatedAtColumn, UpdatedAtColumn, ExpiresAtColumn, PublicIDColumn, MetadataColumn, UserIDColumn}
	)
